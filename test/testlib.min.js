...
var Parseley = (function () {
    ...
    Parseley.prototype.parse = function (str, pos) {
        var parseley = new Parseley();
...
exports.Parseley = Parseley;

},{}],2:[function(require,module,exports){
"use strinct";
"use strict";
var parseley_1 = require('../parseley');
var chai = require('chai');
var assert = chai.assert;
describe('parse function', function () {
    var parseley = null;
    it('when inner variant setup, add a target string and position.', function () {
        parseley = new parseley_1.Parseley().parse('parse string', 0);
    ...
    it('Inner variant no setup.', function () {
        parseley = new parseley_1.Parseley().parse('', 0);
...
},{"../parseley":1,"chai":7}],3:[function(require,module,exports){
/*!
 * assertion-error
...
},{"./flag":19,"assertion-error":3,"type-detect":41}],19:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"./lib/type":42,"dup":38}],42:[function(require,module,exports){
/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
